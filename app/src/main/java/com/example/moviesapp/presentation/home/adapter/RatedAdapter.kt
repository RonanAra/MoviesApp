...
class RatedAdapter() : PagingDataAdapter<Movie,RatedAdapter.ViewHolder>(Movie.DIFF_CALLBACK) {
    ...
    override fun onBindViewHolder(holder: RatedAdapter.ViewHolder, position: Int) {
